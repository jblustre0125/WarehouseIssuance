...
require_once __DIR__ . '/itr_pack_sizes.php';
...
function app_sidebar_icon($name)
{
    $icons = [
        ...
        'qr_print' => '<path d="M4 4h6v6H4V4Z"></path><path d="M14 4h6v6h-6V4Z"></path><path d="M4 14h6v6H4v-6Z"></path><path d="M14 14h2"></path><path d="M18 14h2v2"></path><path d="M14 18h6"></path><path d="M18 20v-2"></path>',
        ...
        'pack_sizes' => '<path d="M6 4h12v16H6V4Z"></path><path d="M9 8h6"></path><path d="M9 12h6"></path><path d="M9 16h3"></path><path d="M16 15l2 2 3-5"></path>',
...
function app_sidebar($active = '')
{
    ...
    $canPrintRawMaterialQr = raw_material_qr_print_can_access($u);
    $canMaintainPackSizes = itr_pack_sizes_can_maintain($u);
    ...
    <aside class="sap-side-nav" id="sidebar" aria-label="Main navigation">
        ...
        <nav class="sap-nav-menu">
            <?php if ($role === $roleAdmin): ?>
                ...
                <?php app_sidebar_link($active, 'raw_material_qr_print', 'pages/issuer/raw_material_qr_print.php', 'qr_print', 'Raw Material QR Labels'); ?>
                <?php app_sidebar_link($active, 'item_locations', 'pages/warehouse/item_locations.php', 'item_locations', 'Item Locations'); ?>
                <?php app_sidebar_link($active, 'pack_sizes', 'pages/warehouse/pack_sizes.php', 'pack_sizes', 'Qty/Pack Maintenance'); ?>
            ...
            <?php elseif ($role === $roleRequestor): ?>
                ...
                <?php if ($canPrintRawMaterialQr || $canMaintainItemLocations || $canMaintainPackSizes): ?>
                    <?php app_sidebar_section('Maintenance'); ?>
                    <?php if ($canPrintRawMaterialQr): ?>
                        <?php app_sidebar_link($active, 'raw_material_qr_print', 'pages/issuer/raw_material_qr_print.php', 'qr_print', 'Raw Material QR Labels'); ?>
                    <?php endif; ?>
                    <?php if ($canMaintainItemLocations): ?>
                        <?php app_sidebar_link($active, 'item_locations', 'pages/warehouse/item_locations.php', 'item_locations', 'Item Locations'); ?>
                    <?php endif; ?>
                    <?php if ($canMaintainPackSizes): ?>
                        <?php app_sidebar_link($active, 'pack_sizes', 'pages/warehouse/pack_sizes.php', 'pack_sizes', 'Qty/Pack Maintenance'); ?>
                    <?php endif; ?>
                <?php endif; ?>
